# Índice rápido das rodadas de UX

- **Rodada 1–4**: consolidadas e implementadas nas versões iniciais (header, hero, responsividade base).
...
- **Rodada 9**: revisão adicional para simplificar hierarquia do header, consolidar toolbar móvel e extrair chips/badges para helpers reutilizáveis.
